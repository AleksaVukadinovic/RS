...
Student::Student(const QString &name, const QString &surname, const QString &index, const QString &personalNumber, bool enrolled,
                 const QVector<CourseItem *> courseItems)
    : m_name(name), m_surname(surname), m_index(index), m_personalNumber(personalNumber), m_enrolled(enrolled), m_courseItems(courseItems) {
